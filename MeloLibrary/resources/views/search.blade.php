...
@section('content')
    <div class="p-4 lg:ml-64 mt-20">
            <form>
                <div class="flex">
                    <label for="search-dropdown" class="mb-2 text-lg font-medium text-gray-900 sr-only dark:text-white">Your Email</label>
        ...
        <div class="flex flex-wrap my-10 px-10 w-full justify-around "> 
                <div class="flex justify-center items-center mb-4 bg-red-800 h-32 w-48 border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
