...
<form enctype="multipart/form-data" method="POST" action="{{ url('/cat/insert/') }}">
  @csrf
  @method('POST')
    <div class="mb-6">
    ...
    <div class="mb-6">
       ...
       <input type="text" name="discription" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 dark:shadow-sm-light" required>
    </div>
    <div class="mb-6">
