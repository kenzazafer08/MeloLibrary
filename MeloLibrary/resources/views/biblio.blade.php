...
@section('content')
    ...
    <div class="p-4 sm:ml-64 mt-20">
        <p class="font-bold text-xl px-4">Your Playlists</p>
        <div class="flex flex-wrap my-10 px-10 w-full justify-around">   
            <div class="w-72 h-80 bg-white border border-gray-200 rounded-lg shadow ">
                ...
                <div class="p-5">
                    <h5 class="text-2xl font-bold tracking-tight text-gray-900 ">chill</h5>
                    <p class="font-normal text-sm text-gray-700 ">- ZAFER Kenza</p>
                </div>
            </div>
            ...
            <div class="w-72 h-80 bg-white border border-gray-200 rounded-lg shadow ">
              <div class="relative h-2/3">
                  ...
                  <button onclick="playA('my-audio')" id='play-A' class="absolute bottom-0 left-0 m-4">
                    ...
                    <audio class="hidden" id="my-audio" src="{{ asset('audios/m3a3chran.mp3') }}"></audio>
                  </button>
                </div>                  
              <div class="p-5">
                  <h5 class="text-2xl font-bold tracking-tight text-gray-900 ">Rap Mghribi</h5>
                  <p class="font-normal text-sm text-gray-700 ">- ZAFER Kenza</p>
              </div>
          </div>
        </div>
